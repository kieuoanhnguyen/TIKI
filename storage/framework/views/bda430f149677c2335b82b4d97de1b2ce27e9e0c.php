...
<body>
    <div class="">
        <div class="d-flex flex-row">
            <div class="col-3">
            <img id="myAnimation" src="images/<?php echo e($product->image); ?>" alt="" class="myAnimation">
            </div>
            <div class="col-9">
                <div class="">
    ...
    <div class="thongtinchitiet">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <td><?php echo e($product->seller->businness_code); ?></td>
                </tr>
                <tr>
...
</html><?php /**PATH /var/www/html/TIKI/resources/views/viewProduct.blade.php ENDPATH**/ ?>